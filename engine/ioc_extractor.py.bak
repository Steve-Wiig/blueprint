...
def extract_iocs(sanitized_alert_json):
    """
    ...
    try:
        ...
        # 90-day window enforcement: Delete records older than 90 days
        cur.execute("DELETE FROM iocs WHERE first_seen < NOW() - INTERVAL '90 days'")
