...
def build_prompt(bundle_text):
    return f"""You are given the complete master documentation bundle for LOCAL-SOC-SLM v11.9
...
- Start with "# LOCAL-SOC-SLM Documentation Errata & Corrections (v11.9)".
